...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // seed
        students.add(new Student("1", "Afsal Ap"));
        students.add(new Student("2", "Zildan"));
        students.add(new Student("3", "Ripal"));
        books.add(new Book("1", "Solo Leveling"));
        books.add(new Book("2", "Mengenal Bahasa Python"));
        books.add(new Book("3", "Cara cepat belajar pemrograman"));
